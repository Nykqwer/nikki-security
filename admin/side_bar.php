<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom:0; background-color:cadetblue;">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="" style="color:white;">
            <i class="fa fa-home fa-large"></i> Automated Voting System
        </a>
    </div>
    ...
    <ul class="nav navbar-top-links navbar-right">
        ...
        <li class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="color: white;">
                <i class="fa fa-cog fa-spin fa-fw"></i> Welcome: <?php echo $user_row['firstname'] . " " . $user_row['lastname']; ?>
            </a>
        </li>
        <?php } ?>
    </ul>
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="backup.php" class="nav-link" style="color: cadetblue;">
                        <i class="fa fa-database"></i> Data Back-Up
                    </a>
                </li>
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href="admin_carousel.php"><i class="fa fa-sign-out"></i> Logout</a>
                        </li>
                    </ul>
                </li>
            </ul>
